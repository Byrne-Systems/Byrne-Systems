 ...
 *
 * @package     UnitTests\testBootstrap
 * @category    UnitTest
...
class testBootstrap extends \PHPUnit_Framework_TestCase {
    ...
    {
        $this->template->set('test', $this->template->viewport($options));
     ...
     */
    public function test_container($content, $type, $expected)
    {
        $this->template->set('test', $this->template->container($content, $type));
        $this->assertEquals($expected, $this->template->output());
    }
    ...
    {
        $this->template->set('test', $this->template->row($content));
        $this->assertEquals($expected, $this->template->output());
    }
    ...
    {
        $this->template->set('test', $this->template->column($amount, $size, $content, $alt));
        $this->assertEquals($expected, $this->template->output());
    }
    ...
    {
        $this->template->set('test', $this->template->panel($type, $caption, $body, $alt));
        $this->assertEquals($expected, $this->template->output());
    }
}
?>