<?php
/**
 * Templating engine developed to substitute special WAFFLE tags while publishing a clean HTML
 * document
 *
...
// use WAFFLE\Interfaces\iTemplate;
...
class Template extends Preload
{
    ...
    public function output()
    {
        if (!file_exists($this->file)) {
            return "[error] cannot load template file ($this->file).";
        }
